<div class="grid px-5 grid-cols-5 gap-4" x-data="{ open: false }">
    ...
    <div class="col-span-5 flex flex-row-reverse">
        ...
        <div wire:click="download('app/file/anexo-2.xlsx')"
        ...
        <div wire:click="download('app/file/anexo-2-extend.xlsx')"
             class="border border-gray-300 w-max pl-2 inline-block hover:bg-siadi-green-100 rounded-lg mr-3 cursor-pointer">
            <span class="py-2 inline-block rounded-l-lg text-sm capitalize">
                Plantilla Extendida
            </span>
    ...
    <div class="col-span-2 pl-2 border-r border-siadi-blue-900">
        ...
        <ol class="list-decimal pl-4 text-siadi-blue-700">
            ...
            <li class="mb-3 text-lg">Seleccionar cual <b class="uppercase">tipo de plantilla</b></li>
   ...
   <livewire:enrollment-form-file-component />
    <div class="col-span-2">
        ...
        @else
            ...
            <p class="text-lg">
                Plantilla básica: Se utiliza para cargar matrículas.

            </p>
            <br>
            <p class="text-lg">
                Plantilla extendida: Se utiliza para cargar matrículas y usuarios plataformas que no existan.
            </p>
            <br>
