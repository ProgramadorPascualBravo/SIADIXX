<div class="col-span-1 flex flex-col items-center">
    ...
    <div class="flex my-3">
        <label for="anexo_user" class="mr-2">
            Básica
            <input class="text-green-500 h-6 w-6 cursor-pointer" type="radio" wire:model="type" name="type" value="1">
        </label>
        <label for="anexo_user" class="ml-2">
            Extendida
            <input class="text-red-500 h-6 w-6 cursor-pointer" type="radio" wire:model="type" name="type" value="0">
        </label>
    </div>
