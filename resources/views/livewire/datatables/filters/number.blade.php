<div class="flex flex-col">
    <div x-data class="relative flex">
        <input
            ...
            class="m-1 pr-6 text-sm leading-4 flex-grow form-input border border-siadi-blue-300 text-siadi-blue-700"
            placeholder="MIN"
        />
    ...
    <div x-data class="relative flex">
        <input
            ...
            class="m-1 pr-6 text-sm leading-4 flex-grow form-input border-siadi-blue-300 text-siadi-blue-700"
            placeholder="MAX"
        />
        <div class="absolute inset-y-0 right-0 pr-2 flex items-center">
            <button x-on:click="$refs.input.value=''" wire:click="doNumberFilterEnd('{{ $index }}', '')" class="inline-flex text-siadi-blue-300 hover:text-red-600 focus:outline-none" tabindex="-1">
                <x-icons.x-circle class="h-3 w-3 stroke-current" />
            </button>
        </div>
    </div>
