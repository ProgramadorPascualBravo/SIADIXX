    ...
    <div class="col-span-3 col-start-2 p-2">
        <div class="grid grid-cols-2 gap-4 px-4">
            <div class="col-span-1">
                ...
                <h2><b>Fecha de verificación :</b> {{ !is_null($user->email_verified_at) ? \Illuminate\Support\Carbon::createFromFormat('Y-m-d H:i:s', $user->email_verified_at)->format('d-m-Y') : "No hay registro" }} </h2>
            </div>
            <div class="col-span-1">
