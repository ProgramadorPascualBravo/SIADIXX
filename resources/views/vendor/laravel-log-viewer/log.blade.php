    ...
    <div class="container-fluid m-4">
        <div class="row">
            <div class="col sidebar mb-3">
                <h1><i class="fa fa-calendar" aria-hidden="true"></i> SIADI logs</h1>
            ...
            <div class="col-10 table-container">
                @if ($logs === null)
                    <div>
                        Archivo de registro> 50 M, descárguelo.
                    </div>
                @else
...
<script type="text/javascript" src="https://raw.githubusercontent.com/DataTables/Plugins/master/i18n/es-mx.json"></script>
<script>
